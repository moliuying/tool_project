  ...
  <div class="number-to-chinese">
    <el-card class="guide-card">
      ...
      <el-steps :active="0" finish-status="wait" simple class="guide-steps">
        ...
        <el-step title="复制结果" description="点击复制按钮，将转换结果粘贴到票据、合同等文档中" />
      </el-steps>
      <el-divider />
    ...
    <el-card class="converter-card">
      <template #header>
        <div class="card-header">
          ...
          <span>数字转中文大写</span>
          <el-tag size="small" type="info" class="header-tag">财务票据专用</el-tag>
        </div>
      </template>
    ...
    <el-card v-if="convertResult.success || convertResult.message" class="result-card">
      <template #header>
        <div class="card-header">
          ...
          <span>转换结果</span>
          <el-tag v-if="convertResult.success" size="small" type="success">转换成功</el-tag>
      ...
      <div v-if="convertResult.success" class="result-content">
        ...
        <div class="result-display">
          <div class="result-label">中文大写金额：</div>
        ...
        <div class="example-section">
          ...
          <el-table :data="examples" border stripe size="small" @row-click="useExample">
            ...
            <el-table-column prop="output" label="中文大写" />
...
const examples = [
  { input: '123.45', output: '壹佰贰拾叁元肆角伍分' },
  { input: '1,000.00', output: '壹仟元整' },
  { input: '1001.50', output: '壹仟零壹元伍角' },
  { input: '12345.67', output: '壹万贰仟叁佰肆拾伍元陆角柒分' },
  { input: '100000', output: '壹拾万元整' },
  { input: '100000000.00', output: '壹亿元整' },
...
const convert = () => {
  ...
  convertResult.value = numberToChinese(inputValue.value)
...
const useExample = (row: { input: string; output: string }) => {
