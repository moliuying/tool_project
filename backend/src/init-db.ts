...
async function bootstrap() {
  ...
  if (menuCount === 0) {
    const menus = [
      ...
      { name: '单位换算', path: '/unit-converter', icon: 'Histogram', parentId: null, sort: 9, component: 'views/UnitConverter.vue' },
      { name: '种子转磁力', path: '/torrent-to-magnet', icon: 'Link', parentId: null, sort: 10, component: 'views/TorrentToMagnet.vue' },
      { name: '节拍练习器', path: '/metronome', icon: 'VideoPlay', parentId: null, sort: 11, component: 'views/Metronome.vue' },
      { name: 'PDF页面调整', path: '/pdf-adjuster', icon: 'Document', parentId: null, sort: 12, component: 'views/PdfAdjuster.vue' },
      { name: '节日头像制作', path: '/holiday-avatar', icon: 'Picture', parentId: null, sort: 13, component: 'views/HolidayAvatarMaker.vue' },
      { name: '颜色空间转换', path: '/color-converter', icon: 'Brush', parentId: null, sort: 14, component: 'views/ColorConverter.vue' },
      { name: '图片水印', path: '/image-watermark', icon: 'Stamp', parentId: null, sort: 15, component: 'views/ImageWatermark.vue' },
      { name: '字幕拼图生成', path: '/subtitle-puzzle', icon: 'Grid', parentId: null, sort: 16, component: 'views/SubtitlePuzzleMaker.vue' },
      { name: 'Linux命令查询', path: '/linux-command', icon: 'Terminal', parentId: null, sort: 17, component: 'views/LinuxCommandHelper.vue' },
      { name: '成语查询', path: '/idiom-query', icon: 'Reading', parentId: null, sort: 18, component: 'views/IdiomQuery.vue' },
      { name: '九宫格切图', path: '/nine-grid-cutter', icon: 'Grid', parentId: null, sort: 19, component: 'views/NineGridCutter.vue' },
      { name: '数字转中文大写', path: '/number-to-chinese', icon: 'Money', parentId: null, sort: 20, component: 'views/NumberToChinese.vue' },
      { name: '文本表达式计算器', path: '/text-expression-calculator', icon: 'Calculator', parentId: null, sort: 21, component: 'views/TextExpressionCalculator.vue' },
      { name: '分区计算器', path: '/partition-calculator', icon: 'Grid', parentId: null, sort: 22, component: 'views/PartitionCalculator.vue' },
      { name: '汉字拆分', path: '/character-splitter', icon: 'EditPen', parentId: null, sort: 23, component: 'views/ChineseCharacterSplitter.vue' },
      { name: '域名WHOIS查询', path: '/domain-whois', icon: 'Search', parentId: null, sort: 24, component: 'views/DomainWhois.vue' },
      { name: 'HTTP头查询', path: '/http-headers', icon: 'Connection', parentId: null, sort: 25, component: 'views/HttpHeadersChecker.vue' },
      { name: '徽章生成器', path: '/shield-badge', icon: 'Medal', parentId: null, sort: 26, component: 'views/ShieldBadgeGenerator.vue' },
      ...
      { name: '日期差计算', path: '/date-difference', icon: 'Calendar', parentId: null, sort: 38, component: 'views/DateDifferenceCalculator.vue' },
      { name: '教学设计生成', path: '/teaching-design', icon: 'Reading', parentId: null, sort: 39, component: 'views/TeachingDesignGenerator.vue' },
      ...
      { name: '菜单管理', path: '/system/menu', icon: 'Menu', parentId: 42, sort: 1, component: 'views/Menu.vue' },
    ];
