...
async function bootstrap() {
  ...
  if (menuCount === 0) {
    const menus = [
      ...
      { name: '系统管理', path: '/system', icon: 'Setting', parentId: null, sort: 12, component: null },
      { name: '菜单管理', path: '/system/menu', icon: 'Menu', parentId: 12, sort: 1, component: 'views/Menu.vue' },
    ];
